...
@override
  ...
  getLengthInState();
  selectedOrder=false;
  _selectedIndex=  tajerAccount?3:2;
  ...
  BottomNavigationBar bottomNavigationBar(){
    return Admin?BottomNavigationBar(
      ...
      items: [
        BottomNavigationBarItem(
          icon: Container(
              ...
              child: Image.asset("Assets/icon-settings.png",color: _selectedIndex==0?Color(0xfff99b1d):Color(0xFF748A9D),)),
              label: 'حسابى',
        ),
        BottomNavigationBarItem(
          icon:Container(
        ...
        BottomNavigationBarItem(
          ...
          label: Admin?'اضافة وجبة':'سلة وجباتى',
        ),
        BottomNavigationBarItem(
          icon:Container(
              margin:EdgeInsets.only(bottom:8,) ,
              child: Image.asset("Assets/icon-recipes.png",color: _selectedIndex==3?Color(0xfff99b1d):Color(0xFF748A9D),)),
          label: 'طالبات شهرية',
        ),
        BottomNavigationBarItem(
          icon: Container(
              margin:EdgeInsets.only(bottom:8,) ,
              child: Image.asset("Assets/icon-store.png",color: _selectedIndex==4?Color(0xfff99b1d):Color(0xFF748A9D),)),
          label: 'الوجبات متاحة',
        ),
      ],
          ...
          Container(
              ...
              child:Stack(
                children: [
                  ...
                  CircleAvatar(
                    radius: 25.0,
                    backgroundColor: Admin?Color(0xff16BA75): _selectedIndex!=1?Color(0xff999BAE):Color(0xffEEEEE).withOpacity(0.4),
                    child: Center(child:Admin? Icon(Icons.add,color: Colors.white,):Image.asset("Assets/noun_basket_821481.png",color: _selectedIndex==1?Color(0xfff99b1d):Color(0xFFFFFFFF),),),
                  ),
                  tajerAccount ||Length==null||Length==0?Container(height: 0,width: 0,) : Positioned(
                    top: 0,
                    right: 0,
